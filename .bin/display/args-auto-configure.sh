...
then
    notify-send "External display setup"
    echo "--output DP-1 --off --output HDMI-1 --primary --mode 1600x900 --pos 0x0 --rotate normal --output eDP-1 --off --output HDMI-2 --off"
    ...
    notify-send "Single display setup"
